...
import { IconExchange, IconCheck, IconQuestionMark, IconArrowRight } from "@tabler/icons-react";
            ...
            <Flex justify="space-between" align="center" mb={40}>
              ...
              <motion.div
                ...
                animate={{ 
                  opacity: 1, 
                  scale: 1,
                  backgroundColor: step >= 4 ? 'rgba(0, 200, 0, 0.15)' : 'rgba(0, 0, 255, 0.05)'
                }}
              ...
              >
                ...
                >
                  <Stack gap={5} align="center">
                    {step < 4 ? (
                      <>
                        <Text size="xs" fw={500} c="#228be6">Would you answer this...</Text>
                        <IconQuestionMark 
                          size={20} 
                          color="#228be6" 
                          style={{ opacity: 0.8 }} 
              ...
              >
                ...
                >
                  <Stack gap={5} align="center">
                    {step < 4 ? (
                      <>
                        <Text size="xs" fw={500} c="#ff6b6b">Would you answer this...</Text>
                        <IconQuestionMark 
                          size={20} 
                          color="#ff6b6b" 
                          style={{ opacity: 0.8 }} 
